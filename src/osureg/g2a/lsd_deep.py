...
def predict_lsd(input):
    ...
    from src.osureg.g2a.deeplsd.utils.tensor import batch_to_device
    from src.osureg.g2a.deeplsd.models.deeplsd_inference import DeepLSD
    from src.osureg.g2a.deeplsd.geometry.viz_2d import plot_images, plot_lines
    MAX_SIZE=3000
    # Model config
    ...
    # Load the model
    ckpt = 'src/osureg/g2a/deeplsd/weights/deeplsd_wireframe.tar'
